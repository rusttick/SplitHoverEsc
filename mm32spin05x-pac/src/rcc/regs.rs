...
impl defmt::Format for Ahbenr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbenr {{ dma1: {=bool:?}, sram: {=bool:?}, flitf: {=bool:?}, crc: {=bool:?}, gpioa: {=bool:?}, gpiob: {=bool:?}, gpioc: {=bool:?}, gpiod: {=bool:?}, hwdiv: {=bool:?} }}",
            self.dma1(),
            self.sram(),
            self.flitf(),
            self.crc(),
...
impl defmt::Format for Ahbrstr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbrstr {{ dma1: {=bool:?}, sram: {=bool:?}, flitf: {=bool:?}, crc: {=bool:?}, gpioa: {=bool:?}, gpiob: {=bool:?}, gpioc: {=bool:?}, gpiod: {=bool:?}, hwdiv: {=bool:?} }}",
            self.dma1(),
            self.sram(),
            self.flitf(),
            self.crc(),
...
impl defmt::Format for Apb2enr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Apb2enr {{ exti: {=bool:?}, adc1: {=bool:?}, tim1: {=bool:?}, spi1: {=bool:?}, uart1: {=bool:?}, comp: {=bool:?}, tim14: {=bool:?}, tim16: {=bool:?}, tim17: {=bool:?}, dbgmcu: {=bool:?}, pwm: {=bool:?} }}",
            self.exti(),
            self.adc1(),
            self.tim1(),
            self.spi1(),
...
impl defmt::Format for Apb2rstr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Apb2rstr {{ exti: {=bool:?}, adc1: {=bool:?}, tim1: {=bool:?}, spi1: {=bool:?}, uart1: {=bool:?}, comp: {=bool:?}, tim14: {=bool:?}, tim16: {=bool:?}, tim17: {=bool:?}, dbgmcu: {=bool:?}, pwm: {=bool:?} }}",
            self.exti(),
            self.adc1(),
            self.tim1(),
            self.spi1(),
...
impl defmt::Format for Cfgr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cfgr {{ sw: {=u8:?}, sws: {=u8:?}, hpre: {=u8:?}, ppre1: {=u8:?}, ppre2: {=u8:?}, mco: {=u8:?} }}",
            self.sw(),
            self.sws(),
            self.hpre(),
            self.ppre1(),
...
impl defmt::Format for Cir {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cir {{ lsirdyf: {=bool:?}, hsirdyf: {=bool:?}, hserdyf: {=bool:?}, cssf: {=bool:?}, lsirdyie: {=bool:?}, hsirdyie: {=bool:?}, hserdyie: {=bool:?}, lsirdyc: {=bool:?}, hsirdyc: {=bool:?}, hserdyc: {=bool:?}, cssc: {=bool:?} }}",
            self.lsirdyf(),
            self.hsirdyf(),
            self.hserdyf(),
            self.cssf(),
...
impl Cr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn hsi_72m(&self) -> bool {
        let val = (self.0 >> 20usize) & 0x01;
        val != 0
    }
    #[doc = "HSI output 72M"]
    #[inline(always)]
    pub const fn set_hsi_72m(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 20usize)) | (((val as u32) & 0x01) << 20usize);
    }
    #[doc = "Quickly wake-up standby mode selection"]
    #[must_use]
    #[inline(always)]
    pub const fn stdby_fs_wk(&self) -> bool {
        let val = (self.0 >> 21usize) & 0x01;
        val != 0
    }
    #[doc = "Quickly wake-up standby mode selection"]
    #[inline(always)]
    pub const fn set_stdby_fs_wk(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 21usize)) | (((val as u32) & 0x01) << 21usize);
    }
}
impl Default for Cr {
...
impl defmt::Format for Cr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cr {{ hsion: {=bool:?}, hsirdy: {=bool:?}, hsiten: {=bool:?}, hsical: {=u8:?}, hseon: {=bool:?}, hserdy: {=bool:?}, hsebyp: {=bool:?}, ccson: {=bool:?}, hsi_72m: {=bool:?}, stdby_fs_wk: {=bool:?} }}",
            self.hsion(),
            self.hsirdy(),
            self.hsiten(),
            self.hsical(),
