...
impl defmt::Format for Comp1Csr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Comp1Csr {{ en: {=bool:?}, mode: {=u8:?}, inm: {=u8:?}, inp: {=u8:?}, out: {=u8:?}, pol: {=bool:?}, hyst: {=u8:?}, oflt: {=u8:?}, sta: {=bool:?}, lock: {=bool:?} }}",
            self.en(),
            self.mode(),
            self.inm(),
            self.inp(),
...
impl Comp1Poll {
    ...
    #[doc = "Comparator 1 polling channel"]
    #[must_use]
    #[inline(always)]
...
impl defmt::Format for Comp1Poll {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Comp1Poll {{ en: {=bool:?}, ch: {=bool:?}, fixn: {=bool:?}, period: {=u8:?}, pout: {=u8:?} }}",
            self.en(),
            self.ch(),
            self.fixn(),
            self.period(),
