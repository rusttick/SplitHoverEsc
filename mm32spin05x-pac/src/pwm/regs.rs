...
impl defmt::Format for Csr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Csr {{ cce: {=bool:?}, cpe: {=bool:?}, apmtie: {=bool:?}, terrie: {=bool:?}, cc_trgsel: {=u8:?}, cc_strg: {=bool:?}, cp_mdsel: {=bool:?}, apmtif: {=bool:?}, terrif: {=bool:?}, ioflt: {=u8:?}, hall_trgsel: {=u8:?}, curen: {=bool:?}, mskdat: {=u8:?}, msken_curr: {=u8:?} }}",
            self.cce(),
            self.cpe(),
            self.apmtie(),
            self.terrie(),
