...
#[doc = "Field `MODE` reader - ADC mode"]
pub type ModeR = crate::FieldReader;
#[doc = "Field `MODE` writer - ADC mode"]
...
#[doc = "Field `CALIBEN` reader - Self-calibration enable"]
pub type CalibenR = crate::BitReader;
#[doc = "Field `CALIBEN` writer - Self-calibration enable"]
pub type CalibenW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CALIBSEL` reader - Self-calibration voltage selection"]
pub type CalibselR = crate::BitReader;
#[doc = "Field `CALIBSEL` writer - Self-calibration voltage selection"]
pub type CalibselW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn caliben(&self) -> CalibenR {
        CalibenR::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - Self-calibration voltage selection"]
    #[inline(always)]
    pub fn calibsel(&self) -> CalibselR {
        CalibselR::new(((self.bits >> 23) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - ADC interrupt enable"]
    ...
    #[doc = "Bit 22 - Self-calibration enable"]
    #[inline(always)]
    pub fn caliben(&mut self) -> CalibenW<'_, CrSpec> {
        CalibenW::new(self, 22)
    }
    #[doc = "Bit 23 - Self-calibration voltage selection"]
    #[inline(always)]
    pub fn calibsel(&mut self) -> CalibselW<'_, CrSpec> {
        CalibselW::new(self, 23)
    }
}
