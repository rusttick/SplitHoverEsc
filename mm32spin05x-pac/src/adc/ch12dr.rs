...
#[doc = "Channel 12 data register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch12dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch12drSpec;
impl crate::RegisterSpec for Ch12drSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch12dr::R`](R) reader structure"]
impl crate::Readable for Ch12drSpec {}
#[doc = "`reset()` method sets CH12DR to value 0"]
impl crate::Resettable for Ch12drSpec {}
