...
impl W {
    ...
    #[inline(always)]
    pub fn dbg_stop_for_ldo(&mut self) -> DbgStopForLdoW<'_, CrSpec> {
    ...
    #[inline(always)]
    pub fn dbg_can_stop(&mut self) -> DbgCanStopW<'_, CrSpec> {
        DbgCanStopW::new(self, 14)
    }
    #[doc = "Bits 16:18 - TIMx counter stopped when core is halted (x = 16,17,14)"]
    #[inline(always)]
    pub fn dbg_tim1x_stop(&mut self) -> DbgTim1xStopW<'_, CrSpec> {
