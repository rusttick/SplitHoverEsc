...
pub const BKP: bkp::Bkp = unsafe { bkp::Bkp::from_ptr(0x4000_2840usize as _) };
#[doc = "Window watchdog"]
...
#[doc = "Debug support"]
pub const CSM: csm::Csm = unsafe { csm::Csm::from_ptr(0x4000_6800usize as _) };
#[doc = "Power control"]
...
pub const HWDIV: hwdiv::Hwdiv = unsafe { hwdiv::Hwdiv::from_ptr(0x4003_0000usize as _) };
