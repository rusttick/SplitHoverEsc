...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Igen(pub u32);
impl Igen {
    #[doc = "Watchdog Interrupt Generate value"]
    #[must_use]
    #[inline(always)]
    pub const fn igen(&self) -> u16 {
        let val = (self.0 >> 0usize) & 0x0fff;
        val as u16
    }
    #[doc = "Watchdog Interrupt Generate value"]
    #[inline(always)]
    pub const fn set_igen(&mut self, val: u16) {
...
impl core::fmt::Debug for Igen {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Igen").field("igen", &self.igen()).finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Igen {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Igen {{ igen: {=u16:?} }}", self.igen())
    }
}
#[doc = "Key register"]
#[repr(transparent)]
...
impl Sr {
    ...
    #[doc = "Watchdog interrupt generate value update"]
    #[must_use]
    #[inline(always)]
    pub const fn ivu(&self) -> bool {
        let val = (self.0 >> 2usize) & 0x01;
        val != 0
    }
    #[doc = "Watchdog interrupt generate value update"]
    #[inline(always)]
    pub const fn set_ivu(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
    }
    #[doc = "Watchdog reload value update flag"]
    #[must_use]
    #[inline(always)]
...
impl defmt::Format for Sr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Sr {{ pvu: {=bool:?}, rvu: {=bool:?}, ivu: {=bool:?}, update: {=bool:?} }}",
            self.pvu(),
            self.rvu(),
            self.ivu(),
            self.update()
