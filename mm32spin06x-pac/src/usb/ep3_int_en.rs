...
impl W {
    #[doc = "Bit 1 - Status stage finished interrupt enable"]
    #[inline(always)]
    pub fn endie(&mut self) -> EndieW<'_, Ep3IntEnSpec> {
        EndieW::new(self, 1)
    }
    #[doc = "Bit 2 - IN-NACK interrupt enable"]
    #[inline(always)]
    pub fn in_nackie(&mut self) -> InNackieW<'_, Ep3IntEnSpec> {
        InNackieW::new(self, 2)
    }
    #[doc = "Bit 3 - IN-ACK interrupt enable"]
    #[inline(always)]
    pub fn in_ackie(&mut self) -> InAckieW<'_, Ep3IntEnSpec> {
        InAckieW::new(self, 3)
    }
    #[doc = "Bit 4 - IN-STALL interrupt enable"]
    #[inline(always)]
    pub fn in_stallie(&mut self) -> InStallieW<'_, Ep3IntEnSpec> {
        InStallieW::new(self, 4)
    }
    #[doc = "Bit 5 - OUT-NACK interrupt enable"]
    #[inline(always)]
    pub fn out_nackie(&mut self) -> OutNackieW<'_, Ep3IntEnSpec> {
        OutNackieW::new(self, 5)
    }
    #[doc = "Bit 6 - OUT-ACK interrupt enable"]
    #[inline(always)]
    pub fn out_ackie(&mut self) -> OutAckieW<'_, Ep3IntEnSpec> {
        OutAckieW::new(self, 6)
    }
    #[doc = "Bit 7 - OUT-STALL interrupt enable"]
    #[inline(always)]
    pub fn out_stallie(&mut self) -> OutStallieW<'_, Ep3IntEnSpec> {
