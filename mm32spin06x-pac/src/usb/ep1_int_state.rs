...
impl W {
    #[doc = "Bit 1 - Status stage finished"]
    #[inline(always)]
    pub fn end(&mut self) -> EndW<'_, Ep1IntStateSpec> {
        EndW::new(self, 1)
    }
    #[doc = "Bit 2 - IN-NACK received"]
    #[inline(always)]
    pub fn in_nacf(&mut self) -> InNacfW<'_, Ep1IntStateSpec> {
        InNacfW::new(self, 2)
    }
    #[doc = "Bit 3 - IN-ACK received"]
    #[inline(always)]
    pub fn in_ackf(&mut self) -> InAckfW<'_, Ep1IntStateSpec> {
        InAckfW::new(self, 3)
    }
    #[doc = "Bit 4 - IN-STALL received"]
    #[inline(always)]
    pub fn in_stallf(&mut self) -> InStallfW<'_, Ep1IntStateSpec> {
        InStallfW::new(self, 4)
    }
    #[doc = "Bit 5 - OUT-NACK received"]
    #[inline(always)]
    pub fn out_nackf(&mut self) -> OutNackfW<'_, Ep1IntStateSpec> {
        OutNackfW::new(self, 5)
    }
    #[doc = "Bit 6 - OUT-ACK received"]
    #[inline(always)]
    pub fn out_ackf(&mut self) -> OutAckfW<'_, Ep1IntStateSpec> {
        OutAckfW::new(self, 6)
    }
    #[doc = "Bit 7 - OUT-STALL received"]
    #[inline(always)]
    pub fn out_stallf(&mut self) -> OutStallfW<'_, Ep1IntStateSpec> {
