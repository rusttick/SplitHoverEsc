...
impl Default for DmaCcr1 {
    #[inline(always)]
    fn default() -> DmaCcr1 {
        DmaCcr1(0)
    }
}
impl core::fmt::Debug for DmaCcr1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DmaCcr1")
            .field("en", &self.en())
...
#[cfg(feature = "defmt")]
impl defmt::Format for DmaCcr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "DmaCcr1 {{ en: {=bool:?}, tcie: {=bool:?}, htie: {=bool:?}, teie: {=bool:?}, dir: {=bool:?}, circ: {=bool:?}, pinc: {=bool:?}, minc: {=bool:?}, psize: {=u8:?}, msize: {=u8:?}, pl: {=u8:?}, mem2mem: {=bool:?}, are: {=bool:?} }}",
            self.en(),
            self.tcie(),
            self.htie(),
            self.teie(),
...
impl Default for DmaCmar1 {
    #[inline(always)]
    fn default() -> DmaCmar1 {
        DmaCmar1(0)
    }
}
impl core::fmt::Debug for DmaCmar1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DmaCmar1").field("ma", &self.ma()).finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for DmaCmar1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "DmaCmar1 {{ ma: {=u32:?} }}", self.ma())
    }
}
#[doc = "DMA channel 1 number of data register"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct DmaCndtr1(pub u32);
impl DmaCndtr1 {
...
impl Default for DmaCndtr1 {
    #[inline(always)]
    fn default() -> DmaCndtr1 {
        DmaCndtr1(0)
    }
}
impl core::fmt::Debug for DmaCndtr1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DmaCndtr1")
            .field("ndt", &self.ndt())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for DmaCndtr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "DmaCndtr1 {{ ndt: {=u16:?} }}", self.ndt())
    }
}
#[doc = "DMA channel 1 peripheral address register"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct DmaCpar1(pub u32);
impl DmaCpar1 {
...
impl Default for DmaCpar1 {
    #[inline(always)]
    fn default() -> DmaCpar1 {
        DmaCpar1(0)
    }
}
impl core::fmt::Debug for DmaCpar1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DmaCpar1").field("pa", &self.pa()).finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for DmaCpar1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "DmaCpar1 {{ pa: {=u32:?} }}", self.pa())
    }
}
#[doc = "DMA interrupt flag clear reigster"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct DmaIfcr(pub u32);
impl DmaIfcr {
...
impl Default for DmaIfcr {
    #[inline(always)]
    fn default() -> DmaIfcr {
        DmaIfcr(0)
    }
}
impl core::fmt::Debug for DmaIfcr {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DmaIfcr")
...
#[cfg(feature = "defmt")]
impl defmt::Format for DmaIfcr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "DmaIfcr {{ cgif1: {=bool:?}, ctcif1: {=bool:?}, chtif1: {=bool:?}, cteif1: {=bool:?}, cgif2: {=bool:?}, ctcif2: {=bool:?}, chtif2: {=bool:?}, cteif2: {=bool:?}, cgif3: {=bool:?}, ctcif3: {=bool:?}, chtif3: {=bool:?}, cteif3: {=bool:?}, cgif4: {=bool:?}, ctcif4: {=bool:?}, chtif4: {=bool:?}, cteif4: {=bool:?}, cgif5: {=bool:?}, ctcif5: {=bool:?}, chtif5: {=bool:?}, cteif5: {=bool:?} }}",
            self.cgif1(),
            self.ctcif1(),
            self.chtif1(),
            self.cteif1(),
...
impl defmt::Format for DmaIsr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "DmaIsr {{ gif1: {=bool:?}, tcif1: {=bool:?}, htif1: {=bool:?}, teif1: {=bool:?}, gif2: {=bool:?}, tcif2: {=bool:?}, htif2: {=bool:?}, teif2: {=bool:?}, gif3: {=bool:?}, tcif3: {=bool:?}, htif3: {=bool:?}, teif3: {=bool:?}, gif4: {=bool:?}, tcif4: {=bool:?}, htif4: {=bool:?}, teif4: {=bool:?}, gif5: {=bool:?}, tcif5: {=bool:?}, htif5: {=bool:?}, teif5: {=bool:?} }}",
            self.gif1(),
            self.tcif1(),
            self.htif1(),
            self.teif1(),
