...
impl W {
    #[doc = "Bit 0 - Event Mask on line 0"]
    #[inline(always)]
    pub fn emr0(&mut self) -> Emr0W<'_, EmrSpec> {
        Emr0W::new(self, 0)
    }
    #[doc = "Bit 1 - Event Mask on line 1"]
    #[inline(always)]
    pub fn emr1(&mut self) -> Emr1W<'_, EmrSpec> {
        Emr1W::new(self, 1)
    }
    #[doc = "Bit 2 - Event Mask on line 2"]
    #[inline(always)]
    pub fn emr2(&mut self) -> Emr2W<'_, EmrSpec> {
        Emr2W::new(self, 2)
    }
    #[doc = "Bit 3 - Event Mask on line 3"]
    #[inline(always)]
    pub fn emr3(&mut self) -> Emr3W<'_, EmrSpec> {
        Emr3W::new(self, 3)
    }
    #[doc = "Bit 4 - Event Mask on line 4"]
    #[inline(always)]
    pub fn emr4(&mut self) -> Emr4W<'_, EmrSpec> {
        Emr4W::new(self, 4)
    }
    #[doc = "Bit 5 - Event Mask on line 5"]
    #[inline(always)]
    pub fn emr5(&mut self) -> Emr5W<'_, EmrSpec> {
        Emr5W::new(self, 5)
    }
    #[doc = "Bit 6 - Event Mask on line 6"]
    #[inline(always)]
    pub fn emr6(&mut self) -> Emr6W<'_, EmrSpec> {
        Emr6W::new(self, 6)
    }
    #[doc = "Bit 7 - Event Mask on line 7"]
    #[inline(always)]
    pub fn emr7(&mut self) -> Emr7W<'_, EmrSpec> {
        Emr7W::new(self, 7)
    }
    #[doc = "Bit 8 - Event Mask on line 8"]
    #[inline(always)]
    pub fn emr8(&mut self) -> Emr8W<'_, EmrSpec> {
        Emr8W::new(self, 8)
    }
    #[doc = "Bit 9 - Event Mask on line 9"]
    #[inline(always)]
    pub fn emr9(&mut self) -> Emr9W<'_, EmrSpec> {
        Emr9W::new(self, 9)
    }
    #[doc = "Bit 10 - Event Mask on line 10"]
    #[inline(always)]
    pub fn emr10(&mut self) -> Emr10W<'_, EmrSpec> {
        Emr10W::new(self, 10)
    }
    #[doc = "Bit 11 - Event Mask on line 11"]
    #[inline(always)]
    pub fn emr11(&mut self) -> Emr11W<'_, EmrSpec> {
        Emr11W::new(self, 11)
    }
    #[doc = "Bit 12 - Event Mask on line 12"]
    #[inline(always)]
    pub fn emr12(&mut self) -> Emr12W<'_, EmrSpec> {
        Emr12W::new(self, 12)
    }
    #[doc = "Bit 13 - Event Mask on line 13"]
    #[inline(always)]
    pub fn emr13(&mut self) -> Emr13W<'_, EmrSpec> {
        Emr13W::new(self, 13)
    }
    #[doc = "Bit 14 - Event Mask on line 14"]
    #[inline(always)]
    pub fn emr14(&mut self) -> Emr14W<'_, EmrSpec> {
        Emr14W::new(self, 14)
    }
    #[doc = "Bit 15 - Event Mask on line 15"]
    #[inline(always)]
    pub fn emr15(&mut self) -> Emr15W<'_, EmrSpec> {
        Emr15W::new(self, 15)
    }
    #[doc = "Bit 16 - Event Mask on line 16"]
    #[inline(always)]
    pub fn emr16(&mut self) -> Emr16W<'_, EmrSpec> {
        Emr16W::new(self, 16)
    }
    #[doc = "Bit 17 - Event Mask on line 17"]
    #[inline(always)]
    pub fn emr17(&mut self) -> Emr17W<'_, EmrSpec> {
        Emr17W::new(self, 17)
    }
    #[doc = "Bit 18 - Event Mask on line 18"]
    #[inline(always)]
    pub fn emr18(&mut self) -> Emr18W<'_, EmrSpec> {
        Emr18W::new(self, 18)
    }
    #[doc = "Bit 19 - Event Mask on line 19"]
    #[inline(always)]
    pub fn emr19(&mut self) -> Emr19W<'_, EmrSpec> {
        Emr19W::new(self, 19)
    }
    #[doc = "Bit 20 - Event Mask on line 20"]
    #[inline(always)]
    pub fn emr20(&mut self) -> Emr20W<'_, EmrSpec> {
        Emr20W::new(self, 20)
    }
    #[doc = "Bit 24 - Event Mask on line 24"]
    #[inline(always)]
    pub fn emr24(&mut self) -> Emr24W<'_, EmrSpec> {
        Emr24W::new(self, 24)
    }
}
