...
impl defmt::Format for Ccer {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ccer {{ cc1e: {=bool:?}, cc1p: {=bool:?}, cc1ne: {=bool:?}, cc1np: {=bool:?}, cc2e: {=bool:?}, cc2p: {=bool:?}, cc2ne: {=bool:?}, cc2np: {=bool:?}, cc3e: {=bool:?}, cc3p: {=bool:?}, cc3ne: {=bool:?}, cc3np: {=bool:?}, cc4e: {=bool:?}, cc4p: {=bool:?}, cc4np: {=bool:?} }}",
            self.cc1e(),
            self.cc1p(),
            self.cc1ne(),
            self.cc1np(),
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Ccr1fall(pub u32);
impl Ccr1fall {
    #[doc = "Capture/compare value for ch1 when counting down in PWM center-aligned mode"]
    #[must_use]
    #[inline(always)]
    pub const fn ccr1fall(&self) -> u16 {
        let val = (self.0 >> 0usize) & 0xffff;
        val as u16
    }
    #[doc = "Capture/compare value for ch1 when counting down in PWM center-aligned mode"]
    #[inline(always)]
    pub const fn set_ccr1fall(&mut self, val: u16) {
        self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
    }
}
impl Default for Ccr1fall {
    #[inline(always)]
    fn default() -> Ccr1fall {
        Ccr1fall(0)
    }
}
impl core::fmt::Debug for Ccr1fall {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Ccr1fall")
            .field("ccr1fall", &self.ccr1fall())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Ccr1fall {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Ccr1fall {{ ccr1fall: {=u16:?} }}", self.ccr1fall())
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Ccr2fall(pub u32);
impl Ccr2fall {
    #[doc = "Capture/compare value for ch2 when counting down in PWM center-aligned mode"]
    #[must_use]
    #[inline(always)]
    pub const fn ccr2fall(&self) -> u16 {
        let val = (self.0 >> 0usize) & 0xffff;
        val as u16
    }
    #[doc = "Capture/compare value for ch2 when counting down in PWM center-aligned mode"]
    #[inline(always)]
    pub const fn set_ccr2fall(&mut self, val: u16) {
        self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
    }
}
impl Default for Ccr2fall {
    #[inline(always)]
    fn default() -> Ccr2fall {
        Ccr2fall(0)
    }
}
impl core::fmt::Debug for Ccr2fall {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Ccr2fall")
            .field("ccr2fall", &self.ccr2fall())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Ccr2fall {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Ccr2fall {{ ccr2fall: {=u16:?} }}", self.ccr2fall())
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Ccr3fall(pub u32);
impl Ccr3fall {
    #[doc = "Capture/compare value for ch3 when counting down in PWM center-aligned mode"]
    #[must_use]
    #[inline(always)]
    pub const fn ccr3fall(&self) -> u16 {
        let val = (self.0 >> 0usize) & 0xffff;
        val as u16
    }
    #[doc = "Capture/compare value for ch3 when counting down in PWM center-aligned mode"]
    #[inline(always)]
    pub const fn set_ccr3fall(&mut self, val: u16) {
        self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
    }
}
impl Default for Ccr3fall {
    #[inline(always)]
    fn default() -> Ccr3fall {
        Ccr3fall(0)
    }
}
impl core::fmt::Debug for Ccr3fall {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Ccr3fall")
            .field("ccr3fall", &self.ccr3fall())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Ccr3fall {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Ccr3fall {{ ccr3fall: {=u16:?} }}", self.ccr3fall())
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Ccr4fall(pub u32);
impl Ccr4fall {
    #[doc = "Capture/compare value for ch4 when counting down in PWM center-aligned mode"]
    #[must_use]
    #[inline(always)]
    pub const fn ccr4fall(&self) -> u16 {
        let val = (self.0 >> 0usize) & 0xffff;
        val as u16
    }
    #[doc = "Capture/compare value for ch4 when counting down in PWM center-aligned mode"]
    #[inline(always)]
    pub const fn set_ccr4fall(&mut self, val: u16) {
        self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
    }
}
impl Default for Ccr4fall {
    #[inline(always)]
    fn default() -> Ccr4fall {
        Ccr4fall(0)
    }
}
impl core::fmt::Debug for Ccr4fall {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Ccr4fall")
            .field("ccr4fall", &self.ccr4fall())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Ccr4fall {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Ccr4fall {{ ccr4fall: {=u16:?} }}", self.ccr4fall())
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Ccr5fall(pub u32);
impl Ccr5fall {
    #[doc = "Capture/compare value for ch5 when counting down in PWM center-aligned mode"]
    #[must_use]
    #[inline(always)]
    pub const fn ccr5fall(&self) -> u16 {
        let val = (self.0 >> 0usize) & 0xffff;
        val as u16
    }
    #[doc = "Capture/compare value for ch5 when counting down in PWM center-aligned mode"]
    #[inline(always)]
    pub const fn set_ccr5fall(&mut self, val: u16) {
        self.0 = (self.0 & !(0xffff << 0usize)) | (((val as u32) & 0xffff) << 0usize);
    }
}
impl Default for Ccr5fall {
    #[inline(always)]
    fn default() -> Ccr5fall {
        Ccr5fall(0)
    }
}
impl core::fmt::Debug for Ccr5fall {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Ccr5fall")
            .field("ccr5fall", &self.ccr5fall())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Ccr5fall {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Ccr5fall {{ ccr5fall: {=u16:?} }}", self.ccr5fall())
    }
}
#[doc = "counter"]
#[repr(transparent)]
...
impl Cr2 {
    ...
    #[doc = "OIS5"]
    #[inline(always)]
    pub const fn set_ois5(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 16usize)) | (((val as u32) & 0x01) << 16usize);
    }
}
...
impl defmt::Format for Cr2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cr2 {{ ccpc: {=bool:?}, ccus: {=bool:?}, ccds: {=bool:?}, mms: {=u8:?}, ti1s: {=bool:?}, ois1: {=bool:?}, ois1n: {=bool:?}, ois2: {=bool:?}, ois2n: {=bool:?}, ois3: {=bool:?}, ois3n: {=bool:?}, ois4: {=bool:?}, ois5: {=bool:?} }}",
            self.ccpc(),
            self.ccus(),
            self.ccds(),
            self.mms(),
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Pder(pub u32);
impl Pder {
    #[doc = "DMA request flow enable"]
    #[must_use]
    #[inline(always)]
    pub const fn ccdrepe(&self) -> bool {
        let val = (self.0 >> 0usize) & 0x01;
        val != 0
    }
    #[doc = "DMA request flow enable"]
    #[inline(always)]
    pub const fn set_ccdrepe(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
    }
    #[doc = "CCR1 pwm shift enable"]
    #[must_use]
    #[inline(always)]
    pub const fn ccr1shiften(&self) -> bool {
        let val = (self.0 >> 1usize) & 0x01;
        val != 0
    }
    #[doc = "CCR1 pwm shift enable"]
    #[inline(always)]
    pub const fn set_ccr1shiften(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val as u32) & 0x01) << 1usize);
    }
    #[doc = "CCR2 pwm shift enable"]
    #[must_use]
    #[inline(always)]
    pub const fn ccr2shiften(&self) -> bool {
        let val = (self.0 >> 2usize) & 0x01;
        val != 0
    }
    #[doc = "CCR2 pwm shift enable"]
    #[inline(always)]
    pub const fn set_ccr2shiften(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val as u32) & 0x01) << 2usize);
    }
    #[doc = "CCR3 pwm shift enable"]
    #[must_use]
    #[inline(always)]
    pub const fn ccr3shiften(&self) -> bool {
        let val = (self.0 >> 3usize) & 0x01;
        val != 0
    }
    #[doc = "CCR3 pwm shift enable"]
    #[inline(always)]
    pub const fn set_ccr3shiften(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
    }
    #[doc = "CCR4 pwm shift enable"]
    #[must_use]
    #[inline(always)]
    pub const fn ccr4shiften(&self) -> bool {
        let val = (self.0 >> 4usize) & 0x01;
        val != 0
    }
    #[doc = "CCR4 pwm shift enable"]
    #[inline(always)]
    pub const fn set_ccr4shiften(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val as u32) & 0x01) << 4usize);
    }
    #[doc = "CCR5 pwm shift enable"]
    #[must_use]
    #[inline(always)]
    pub const fn ccr5shiften(&self) -> bool {
        let val = (self.0 >> 5usize) & 0x01;
        val != 0
    }
    #[doc = "CCR5 pwm shift enable"]
    #[inline(always)]
    pub const fn set_ccr5shiften(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 5usize)) | (((val as u32) & 0x01) << 5usize);
    }
}
impl Default for Pder {
    #[inline(always)]
    fn default() -> Pder {
        Pder(0)
    }
}
impl core::fmt::Debug for Pder {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("Pder")
            .field("ccdrepe", &self.ccdrepe())
            .field("ccr1shiften", &self.ccr1shiften())
            .field("ccr2shiften", &self.ccr2shiften())
            .field("ccr3shiften", &self.ccr3shiften())
            .field("ccr4shiften", &self.ccr4shiften())
            .field("ccr5shiften", &self.ccr5shiften())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for Pder {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pder {{ ccdrepe: {=bool:?}, ccr1shiften: {=bool:?}, ccr2shiften: {=bool:?}, ccr3shiften: {=bool:?}, ccr4shiften: {=bool:?}, ccr5shiften: {=bool:?} }}",
            self.ccdrepe(),
            self.ccr1shiften(),
            self.ccr2shiften(),
            self.ccr3shiften(),
...
impl Rcr {
    ...
    #[doc = "Repetition counter value of real-time writing"]
    #[must_use]
    #[inline(always)]
    pub const fn rep_cnt(&self) -> u8 {
        let val = (self.0 >> 8usize) & 0xff;
        val as u8
    }
    #[doc = "Repetition counter value of real-time writing"]
    #[inline(always)]
    pub const fn set_rep_cnt(&mut self, val: u8) {
