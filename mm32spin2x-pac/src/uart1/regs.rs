...
impl defmt::Format for Ccr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ccr {{ pen: {=bool:?}, psel: {=bool:?}, spb0: {=bool:?}, brk: {=bool:?}, char: {=u8:?}, spb1: {=bool:?}, b8rxd: {=bool:?}, b8txd: {=bool:?}, b8pol: {=bool:?}, b8tog: {=bool:?}, b8en: {=bool:?}, rwu: {=bool:?}, wake: {=bool:?} }}",
            self.pen(),
            self.psel(),
            self.spb0(),
            self.brk(),
...
impl defmt::Format for Gcr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Gcr {{ uarten: {=bool:?}, dmamode: {=bool:?}, autoflowen: {=bool:?}, rxen: {=bool:?}, txen: {=bool:?} }}",
            self.uarten(),
            self.dmamode(),
            self.autoflowen(),
            self.rxen(),
...
impl defmt::Format for Icr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Icr {{ txiclr: {=bool:?}, rxiclr: {=bool:?}, txc_clr: {=bool:?}, rxoerrclr: {=bool:?}, rxperrclr: {=bool:?}, rxferrclr: {=bool:?}, rxbrkclr: {=bool:?}, txbrk_clr: {=bool:?}, rxb8_clr: {=bool:?} }}",
            self.txiclr(),
            self.rxiclr(),
            self.txc_clr(),
            self.rxoerrclr(),
...
impl defmt::Format for Ier {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ier {{ txien: {=bool:?}, rxien: {=bool:?}, txc_ien: {=bool:?}, rxoerren: {=bool:?}, rxperren: {=bool:?}, rxferren: {=bool:?}, rxbrken: {=bool:?}, txbrk_ien: {=bool:?}, rxb8_ien: {=bool:?} }}",
            self.txien(),
            self.rxien(),
            self.txc_ien(),
            self.rxoerren(),
...
impl defmt::Format for Isr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Isr {{ tx_intf: {=bool:?}, rx_intf: {=bool:?}, txc_intf: {=bool:?}, rxoerr_intf: {=bool:?}, rxperr_intf: {=bool:?}, rxferr_intf: {=bool:?}, rxbrk_intf: {=bool:?}, txbrk_intf: {=bool:?}, rxb8_intf: {=bool:?} }}",
            self.tx_intf(),
            self.rx_intf(),
            self.txc_intf(),
            self.rxoerr_intf(),
