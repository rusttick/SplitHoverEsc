...
impl defmt::Format for Cr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cr {{ master: {=bool:?}, speed: {=u8:?}, slave10: {=bool:?}, master10: {=bool:?}, repen: {=bool:?}, disslave: {=bool:?}, stopint: {=bool:?}, empint: {=bool:?}, stop: {=bool:?}, restart: {=bool:?} }}",
            self.master(),
            self.speed(),
            self.slave10(),
            self.master10(),
...
impl Rawisr {
    ...
    #[doc = "RESTART_DET interrupt status"]
    #[must_use]
    #[inline(always)]
    pub const fn restart(&self) -> bool {
    ...
    #[doc = "MST_ON_HOLD interrupt status"]
    #[must_use]
    #[inline(always)]
...
impl defmt::Format for Rawisr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Rawisr {{ rx_under: {=bool:?}, rx_over: {=bool:?}, rx_full: {=bool:?}, tx_over: {=bool:?}, tx_empty: {=bool:?}, rd_req: {=bool:?}, tx_abrt: {=bool:?}, rx_done: {=bool:?}, activ: {=bool:?}, stop: {=bool:?}, start: {=bool:?}, gc: {=bool:?}, restart: {=bool:?}, hold: {=bool:?} }}",
            self.rx_under(),
            self.rx_over(),
            self.rx_full(),
            self.tx_over(),
