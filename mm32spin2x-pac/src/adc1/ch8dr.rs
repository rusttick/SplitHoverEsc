...
#[doc = "Channel 8 data register\n\nYou can [`read`](crate::Reg::read) this register and get [`ch8dr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch8drSpec;
impl crate::RegisterSpec for Ch8drSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch8dr::R`](R) reader structure"]
impl crate::Readable for Ch8drSpec {}
#[doc = "`reset()` method sets CH8DR to value 0"]
impl crate::Resettable for Ch8drSpec {}
