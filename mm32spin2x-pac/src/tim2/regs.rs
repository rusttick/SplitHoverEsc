...
impl defmt::Format for Ccer {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ccer {{ cc1e: {=bool:?}, cc1p: {=bool:?}, cc2e: {=bool:?}, cc2p: {=bool:?}, cc3e: {=bool:?}, cc3p: {=bool:?}, cc4e: {=bool:?}, cc4p: {=bool:?} }}",
            self.cc1e(),
            self.cc1p(),
            self.cc2e(),
            self.cc2p(),
...
impl Ccr1 {
    ...
    #[doc = "Capture/Compare 1 value"]
    #[inline(always)]
    pub const fn set_ccr1(&mut self, val: u32) {
        self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
    }
}
...
impl defmt::Format for Ccr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Ccr1 {{ ccr1: {=u32:?} }}", self.ccr1())
    }
}
...
impl Ccr2 {
    ...
    #[doc = "Capture/Compare 2 value"]
    #[inline(always)]
    pub const fn set_ccr2(&mut self, val: u32) {
        self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
    }
}
...
impl defmt::Format for Ccr2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Ccr2 {{ ccr2: {=u32:?} }}", self.ccr2())
    }
}
...
impl Ccr3 {
    ...
    #[doc = "Capture/Compare 3 value"]
    #[inline(always)]
    pub const fn set_ccr3(&mut self, val: u32) {
        self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
    }
}
...
impl defmt::Format for Ccr3 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Ccr3 {{ ccr3: {=u32:?} }}", self.ccr3())
    }
}
...
impl Ccr4 {
    ...
    #[doc = "Capture/Compare 4 value"]
    #[inline(always)]
    pub const fn set_ccr4(&mut self, val: u32) {
        self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
    }
}
...
impl defmt::Format for Ccr4 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Ccr4 {{ ccr4: {=u32:?} }}", self.ccr4())
    }
}
#[doc = "counter"]
#[repr(transparent)]
...
impl defmt::Format for Egr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Egr {{ ug: {=bool:?}, cc1g: {=bool:?}, cc2g: {=bool:?}, cc3g: {=bool:?}, cc4g: {=bool:?}, tg: {=bool:?} }}",
            self.ug(),
            self.cc1g(),
            self.cc2g(),
            self.cc3g(),
