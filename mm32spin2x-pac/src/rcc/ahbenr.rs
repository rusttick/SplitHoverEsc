...
#[doc = "Field `HWSQRT` reader - HWSQRT clock enable"]
pub type HwsqrtR = crate::BitReader;
#[doc = "Field `HWSQRT` writer - HWSQRT clock enable"]
...
impl R {
    ...
    #[doc = "Bit 25 - HWSQRT clock enable"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 25 - HWSQRT clock enable"]
    #[inline(always)]
    pub fn hwsqrt(&mut self) -> HwsqrtW<'_, AhbenrSpec> {
        HwsqrtW::new(self, 25)
    }
    #[doc = "Bit 26 - HWDIV clock enable"]
    #[inline(always)]
