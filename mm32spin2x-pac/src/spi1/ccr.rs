...
impl W {
    #[doc = "Bit 0 - Clock phase select bit"]
    #[inline(always)]
    pub fn cpha(&mut self) -> CphaW<'_, CcrSpec> {
        CphaW::new(self, 0)
    }
    #[doc = "Bit 1 - Clock polarity select bit"]
    #[inline(always)]
    pub fn cpol(&mut self) -> CpolW<'_, CcrSpec> {
        CpolW::new(self, 1)
    }
    #[doc = "Bit 2 - LSI first enable bit"]
    #[inline(always)]
    pub fn lsbfe(&mut self) -> LsbfeW<'_, CcrSpec> {
        LsbfeW::new(self, 2)
    }
    #[doc = "Bit 3 - SPI character length bit"]
    #[inline(always)]
    pub fn spilen(&mut self) -> SpilenW<'_, CcrSpec> {
        SpilenW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive data edge select"]
    #[inline(always)]
    pub fn rxedge(&mut self) -> RxedgeW<'_, CcrSpec> {
        RxedgeW::new(self, 4)
    }
    #[doc = "Bit 5 - Transmit data edge select"]
    #[inline(always)]
    pub fn txedge(&mut self) -> TxedgeW<'_, CcrSpec> {
        TxedgeW::new(self, 5)
    }
    #[doc = "Bit 6 - CPHA polarity select"]
    #[inline(always)]
    pub fn cphasel(&mut self) -> CphaselW<'_, CcrSpec> {
        CphaselW::new(self, 6)
    }
}
