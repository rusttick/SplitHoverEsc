...
#[doc = "Field `RXMATCH_INTF` reader - Receive data match the RDNR number"]
pub type RxmatchIntfR = crate::BitReader;
#[doc = "Field `RXMATCH_INTF` writer - Receive data match the RDNR number"]
...
impl W {
    #[doc = "Bit 0 - Transmit FIFO avialable interrupt flag bit"]
    #[inline(always)]
    pub fn tx_intf(&mut self) -> TxIntfW<'_, IsrSpec> {
        TxIntfW::new(self, 0)
    }
    #[doc = "Bit 1 - Receive data available interrupt flag bit"]
    #[inline(always)]
    pub fn rx_intf(&mut self) -> RxIntfW<'_, IsrSpec> {
        RxIntfW::new(self, 1)
    }
    #[doc = "Bit 2 - SPI underrun interrupt flag bit"]
    #[inline(always)]
    pub fn underrun_intf(&mut self) -> UnderrunIntfW<'_, IsrSpec> {
        UnderrunIntfW::new(self, 2)
    }
    #[doc = "Bit 3 - Receive overrun error interrupt flag bit"]
    #[inline(always)]
    pub fn rxoerr_intf(&mut self) -> RxoerrIntfW<'_, IsrSpec> {
        RxoerrIntfW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive data match the RDNR number"]
    #[inline(always)]
    pub fn rxmatch_intf(&mut self) -> RxmatchIntfW<'_, IsrSpec> {
        RxmatchIntfW::new(self, 4)
    }
    #[doc = "Bit 5 - RX FIFO full interrupt flag bit"]
    #[inline(always)]
    pub fn rxfull_intf(&mut self) -> RxfullIntfW<'_, IsrSpec> {
        RxfullIntfW::new(self, 5)
    }
    #[doc = "Bit 6 - Transmitter empty interrupt flag bit"]
    #[inline(always)]
    pub fn txept_intf(&mut self) -> TxeptIntfW<'_, IsrSpec> {
