...
impl W {
    #[doc = "Bit 0 - Transmit FIFO empty interrupt enable bit"]
    #[inline(always)]
    pub fn tx_ien(&mut self) -> TxIenW<'_, IerSpec> {
        TxIenW::new(self, 0)
    }
    #[doc = "Bit 1 - Receive FIFO interrupt enable bit"]
    #[inline(always)]
    pub fn rx_ien(&mut self) -> RxIenW<'_, IerSpec> {
        RxIenW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmitter underrun interrupt enable bit(SPI slave mode only)"]
    #[inline(always)]
    pub fn underrun_ien(&mut self) -> UnderrunIenW<'_, IerSpec> {
        UnderrunIenW::new(self, 2)
    }
    #[doc = "Bit 3 - Overrun error interrupt enable bit"]
    #[inline(always)]
    pub fn rxoerr_ien(&mut self) -> RxoerrIenW<'_, IerSpec> {
        RxoerrIenW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive data complete interrupt enable bit"]
    #[inline(always)]
    pub fn rxmatch_ien(&mut self) -> RxmatchIenW<'_, IerSpec> {
        RxmatchIenW::new(self, 4)
    }
    #[doc = "Bit 5 - Receive FIFO full interrupt enable bit"]
    #[inline(always)]
    pub fn rxfull_ien(&mut self) -> RxfullIenW<'_, IerSpec> {
        RxfullIenW::new(self, 5)
    }
    #[doc = "Bit 6 - Transmit empty interrupt enable bit"]
    #[inline(always)]
    pub fn txept_ien(&mut self) -> TxeptIenW<'_, IerSpec> {
