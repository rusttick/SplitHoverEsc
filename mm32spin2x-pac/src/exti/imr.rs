...
#[doc = "Field `IMR21` reader - Interrupt Mask on line 21"]
pub type Imr21R = crate::BitReader;
#[doc = "Field `IMR21` writer - Interrupt Mask on line 21"]
pub type Imr21W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IMR22` reader - Interrupt Mask on line 22"]
pub type Imr22R = crate::BitReader;
#[doc = "Field `IMR22` writer - Interrupt Mask on line 22"]
pub type Imr22W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `IMR23` reader - Interrupt Mask on line 23"]
pub type Imr23R = crate::BitReader;
#[doc = "Field `IMR23` writer - Interrupt Mask on line 23"]
pub type Imr23W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn imr21(&self) -> Imr21R {
        Imr21R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - Interrupt Mask on line 22"]
    #[inline(always)]
    pub fn imr22(&self) -> Imr22R {
        Imr22R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - Interrupt Mask on line 23"]
    #[inline(always)]
    pub fn imr23(&self) -> Imr23R {
        Imr23R::new(((self.bits >> 23) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 20 - Interrupt Mask on line 20"]
    #[inline(always)]
    pub fn imr20(&mut self) -> Imr20W<'_, ImrSpec> {
        Imr20W::new(self, 20)
    }
    #[doc = "Bit 21 - Interrupt Mask on line 21"]
    #[inline(always)]
    pub fn imr21(&mut self) -> Imr21W<'_, ImrSpec> {
        Imr21W::new(self, 21)
    }
    #[doc = "Bit 22 - Interrupt Mask on line 22"]
    #[inline(always)]
    pub fn imr22(&mut self) -> Imr22W<'_, ImrSpec> {
        Imr22W::new(self, 22)
    }
    #[doc = "Bit 23 - Interrupt Mask on line 23"]
    #[inline(always)]
    pub fn imr23(&mut self) -> Imr23W<'_, ImrSpec> {
        Imr23W::new(self, 23)
    }
    #[doc = "Bit 24 - Interrupt Mask on line 24"]
    #[inline(always)]
