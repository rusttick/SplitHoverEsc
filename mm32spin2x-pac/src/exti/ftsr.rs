...
#[doc = "Field `TR21` reader - Falling trigger event configuration bit of line 21"]
pub type Tr21R = crate::BitReader;
#[doc = "Field `TR21` writer - Falling trigger event configuration bit of line 21"]
pub type Tr21W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TR22` reader - Falling trigger event configuration bit of line 22"]
pub type Tr22R = crate::BitReader;
#[doc = "Field `TR22` writer - Falling trigger event configuration bit of line 22"]
pub type Tr22W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TR23` reader - Falling trigger event configuration bit of line 23"]
pub type Tr23R = crate::BitReader;
#[doc = "Field `TR23` writer - Falling trigger event configuration bit of line 23"]
...
impl R {
    ...
    #[doc = "Bit 21 - Falling trigger event configuration bit of line 21"]
    #[inline(always)]
    pub fn tr21(&self) -> Tr21R {
        Tr21R::new(((self.bits >> 21) & 1) != 0)
    }
    #[doc = "Bit 22 - Falling trigger event configuration bit of line 22"]
    #[inline(always)]
    pub fn tr22(&self) -> Tr22R {
        Tr22R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - Falling trigger event configuration bit of line 23"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 19 - Falling trigger event configuration bit of line 19"]
    #[inline(always)]
    pub fn tr19(&mut self) -> Tr19W<'_, FtsrSpec> {
        Tr19W::new(self, 19)
    }
    #[doc = "Bit 20 - Falling trigger event configuration bit of line 20"]
    #[inline(always)]
    pub fn tr20(&mut self) -> Tr20W<'_, FtsrSpec> {
        Tr20W::new(self, 20)
    }
    #[doc = "Bit 21 - Falling trigger event configuration bit of line 21"]
    #[inline(always)]
    pub fn tr21(&mut self) -> Tr21W<'_, FtsrSpec> {
        Tr21W::new(self, 21)
    }
    #[doc = "Bit 22 - Falling trigger event configuration bit of line 22"]
    #[inline(always)]
    pub fn tr22(&mut self) -> Tr22W<'_, FtsrSpec> {
        Tr22W::new(self, 22)
    }
    #[doc = "Bit 23 - Falling trigger event configuration bit of line 23"]
    #[inline(always)]
    pub fn tr23(&mut self) -> Tr23W<'_, FtsrSpec> {
        Tr23W::new(self, 23)
    }
    #[doc = "Bit 24 - Falling trigger event configuration bit of line 24"]
    #[inline(always)]
    pub fn tr24(&mut self) -> Tr24W<'_, FtsrSpec> {
        Tr24W::new(self, 24)
    }
}
