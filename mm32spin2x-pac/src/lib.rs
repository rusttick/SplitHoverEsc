...
pub const BKP: bkp::Bkp = unsafe { bkp::Bkp::from_ptr(0x4000_280cusize as _) };
#[doc = "Window watchdog"]
...
pub const TIM8: tim1::Tim1 = unsafe { tim1::Tim1::from_ptr(0x4001_0800usize as _) };
#[doc = "Analog to digital converter 1"]
pub const ADC1: adc1::Adc1 = unsafe { adc1::Adc1::from_ptr(0x4001_2400usize as _) };
#[doc = "Analog to digital converter 2"]
pub const ADC2: adc2::Adc2 = unsafe { adc2::Adc2::from_ptr(0x4001_2800usize as _) };
#[doc = "Advanced timer"]
...
pub const OPAMP: opamp::Opamp = unsafe { opamp::Opamp::from_ptr(0x4001_3c10usize as _) };
...
#[doc = "Hardware Square"]
pub const SQRT: sqrt::Sqrt = unsafe { sqrt::Sqrt::from_ptr(0x4003_0400usize as _) };
