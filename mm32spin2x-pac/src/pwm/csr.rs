...
#[doc = "Field `CP_TRGSEL` reader - Current Protection Trigger Selection"]
pub type CpTrgselR = crate::FieldReader;
#[doc = "Field `CP_TRGSEL` writer - Current Protection Trigger Selection"]
pub type CpTrgselW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
impl R {
    ...
    #[doc = "Bits 7:9 - Current Protection Trigger Selection"]
    #[inline(always)]
    pub fn cp_trgsel(&self) -> CpTrgselR {
        CpTrgselR::new(((self.bits >> 7) & 7) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 7:9 - Current Protection Trigger Selection"]
    #[inline(always)]
    pub fn cp_trgsel(&mut self) -> CpTrgselW<'_, CsrSpec> {
        CpTrgselW::new(self, 7)
    }
    #[doc = "Bit 10 - Current Protection Mode Selection"]
    #[inline(always)]
